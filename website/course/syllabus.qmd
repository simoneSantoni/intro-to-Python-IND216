...
module IND219's Moodle page. The deadline for quiz submission is **TBD**.
...
- The present website (and its underlying [GitHub
  repository](https://github.com/simoneSantoni/intro-to-Python-IND219))
...
3. **Office Hours**: In-depth conceptual discussions (reach out to
   [Yuanheng.Li.2@city.ac.uk](mailto:Yuanheng.Li.2@city.ac.uk) to book your
   appointment)
